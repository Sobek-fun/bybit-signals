...
def build_decision_rows(
    ...
    if episodes.empty:
        ...
        stage_done(
            "ROWS", "BUILD_DECISION_ROWS", elapsed_sec=time.perf_counter() - started
        )
        return out
    context_by_symbol = {
    ...
    for episode in episodes.itertuples(index=False):
        ...
        episode_slice["distance_from_episode_high_pct"] = (
            episode_slice["episode_high_so_far"] - episode_slice["close"]
        ) / episode_slice["episode_high_so_far"]
            ...
            rows.append(
                {
                    ...
                    "distance_from_episode_high_pct": float(
                        row.distance_from_episode_high_pct
                    ),
