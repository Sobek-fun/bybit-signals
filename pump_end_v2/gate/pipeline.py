...
from pump_end_v2.gate.threshold import select_gate_block_threshold
...
def build_gate_val_scored_signals_and_threshold(
...
) -> tuple[CatBoostClassifier, pd.DataFrame, float, pd.DataFrame]:
    ...
    selected_block_threshold, threshold_sweep_df = select_gate_block_threshold(
    ...
    return model, val_scored_signals_df, selected_block_threshold, threshold_sweep_df
...
def build_gate_test_scored_signals(
    ...
    return model, test_scored_signals_df
